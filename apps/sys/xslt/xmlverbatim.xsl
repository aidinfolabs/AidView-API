...
<!--
   ...
   Contributors: Doug Dicks, added auto-indent (parameter indent-elements)
                 for pretty-print
-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:verb="http://informatik.hu-berlin.de/xmlverbatim" version="2.0" exclude-result-prefixes="verb" id="xmlpp">
    ...
    <!-- root -->
    <xsl:template match="/doc" mode="xmlverb">
        <xsl:text/>
        <xsl:comment>
