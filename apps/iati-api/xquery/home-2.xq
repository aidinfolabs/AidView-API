...
import module namespace iati-h = "http://kitwallace.me/iati-h" at "../lib/iati-h-2.xqm";  
...
let $content := iati-h:home-content($query,"home.xq") 
let $logit := log:log-request("iati","home-2","")
return  
 ...
 <html> 
   ...
   <body>
   <h1><a href="home.xq">IATI-API - Home</a></h1>
   {$content}
