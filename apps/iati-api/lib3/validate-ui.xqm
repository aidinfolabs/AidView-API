module namespace admin-validate-ui = "http://kitwallace.me/admin-validate-ui";
   ...
   then  let $activities := collection($activity-collection)/iati-activity[@iati-ad:activitySet=$query/src]     
         ...
         <div>
          <div class="nav">
           ...
           {validate:activities-analysis($activities,concat("?mode=analysis&amp;type=activitySet&amp;src=",encode-for-uri($query/src),"&amp;id="))}
         </div>
