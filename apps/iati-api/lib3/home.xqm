...
then
     ...
     let $hosts := doc(concat($config:base,"cache/",$query/corpus,"/corpus-statistics.xml"))/stats/host
 ...
 then 
     ...
     let $host := doc(concat($config:base,"cache/",$query/corpus,"/corpus-statistics.xml"))/stats/host[download_url=$query/host]
     return  <div  class="cache">
               <div class="nav">
...
then
    ...
    let $funders := doc(concat($config:base,"cache/",$query/corpus,"/corpus-statistics.xml"))/stats/funder
    return  <div  class="cache">
               <div class="nav">              
                  <span>Funders</span> >
               </div>
 ...
 then 
     let $funder := doc(concat($config:base,"cache/",$query/corpus,"/corpus-statistics.xml"))/stats/funder[code=$query/funder]
