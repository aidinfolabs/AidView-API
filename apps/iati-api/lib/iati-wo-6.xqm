...
return
if ($query/result= ("count","ids","values","summary","full","geo","details"))
then 
        ...
        then 
             ...
             return 
                element iati-activity {
                     ...
                     element funder {string(($activity/reporting-org/@iati-ad:funder,$activity/participating-org/@iati-ad:funder)[1])}
              }
         else $selected-items 
