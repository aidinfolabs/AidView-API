...
import module namespace admin-ui = "http://tools.aidinfolabs.org/api/admin-ui" at "../lib/admin-ui.xqm";
...
let $admin-query := doc(concat($config:system,"model.xml"))/model/entity[@name="admin-query"]
...
let $content := admin-ui:admin-content($query,"admin.xq") 
return  
