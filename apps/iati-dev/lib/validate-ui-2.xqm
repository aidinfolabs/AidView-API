module namespace validate-ui = "http://tools.aidinfolabs.org/api/validate-ui";
...
declare function validate-ui:validate-content($query as item(), $script as xs:string ) {
